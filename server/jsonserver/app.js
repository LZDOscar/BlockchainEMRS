...
app.get('/delete/:id/:hash',function(req,res) {
    console.log("app "+req.params.id+ "  " +req.params.hash);
    client.invoke("delete",req.params.id,req.params.hash,function(err,result,more){  
    res.jsonp({'result':result});
    });
});
